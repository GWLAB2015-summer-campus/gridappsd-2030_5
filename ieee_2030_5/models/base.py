...
class DeviceCategoryType(enum.IntFlag):
    ...
    programable_communicating_thermostat = 0
    strip_heater = 1
    baseboard_heater = 2
    water_heater = 3
    pool_pump = 4
    ...
    smart_appliance = 7
    irrigation_pump = 8
    managed_commercical_loads = 9
    simple_misc_loads = 10  # Residential on/off loads
    ...
    other_generation_system = 24
    other_storage_system = 25
...
class DeviceInformation(BaseModel):
    ...
    functions_implemented: Optional[FunctionsImplementedType] = Field(alias='functionsImplemented',
                                                                      description='Bitmap indicating the function sets used by the device as a client')
    ...
    mf_info: Optional[str] = Field(alias='mfInfo',
                                   description='Manufacturer dependent information related to the manufacture of this device')
